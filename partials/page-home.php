<div id="page-home" class="page-view active">
  ...
  <div class="section" style="background:var(--bg-off); padding-bottom:1rem">
    ...
    <p style="font-size:0.68rem;color:rgba(57,52,30,0.45);text-align:center;padding:1.5rem clamp(2rem,6vw,5rem) 3rem">Testimonials provided by current clients. No compensation was provided. Results may vary.</p>
  </div>
